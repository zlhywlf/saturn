  ...
  <div>
    <div class="d-flex align-center pa-5">
      <v-avatar size="32" class="mr-2">
        <img src="@/assets/logo.svg" width="32" alt="Julia" />
      </v-avatar>
      <div>
        ...
        <v-window-item value="111">
          <v-list class="py-0" aria-label="profile list" aria-busy="true">
            <v-list-item color="primary" rounded="0" value="Edit profile">
              ...
              <v-list-item-title class="fs-1"> Edit Profile</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="View Profile">
              ...
              <v-list-item-title class="fs-1"> View Profile</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="Social Profile">
              ...
              <v-list-item-title class="fs-1"> Social Profile</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="Billing">
              ...
              <v-list-item-title class="fs-1"> Billing</v-list-item-title>
            </v-list-item>
        ...
        <v-window-item value="222">
          <v-list class="py-0" aria-label="profile list" aria-busy="true">
            <v-list-item color="primary" rounded="0" value="Support">
              ...
              <v-list-item-title class="fs-1"> Support</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="Account">
              ...
              <v-list-item-title class="fs-1"> Account settings</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="Privacy">
              ...
              <v-list-item-title class="fs-1"> Privacy center</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="Feedback">
              ...
              <v-list-item-title class="fs-1"> Feedback</v-list-item-title>
            </v-list-item>
            ...
            <v-list-item color="primary" rounded="0" value="History">
              ...
              <v-list-item-title class="fs-1"> History</v-list-item-title>
            </v-list-item>
          </v-list>
        </v-window-item>
      </v-window>
